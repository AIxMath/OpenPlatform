  ...
  <div class="min-h-screen bg-gray-50 py-8 px-4">
    <div class="max-w-6xl mx-auto">
      ...
      <div class="flex items-center justify-between mb-6">
        <div>
          <h1 class="text-2xl font-light text-gray-800">我的文章</h1>
      ...
      <div v-if="isLoading" class="flex items-center justify-center py-20">
        <div class="text-center">
          <div class="inline-block w-12 h-12 border-4 border-gray-800 border-t-transparent rounded-full animate-spin mb-3"></div>
      ...
      <div v-else-if="blogs.length === 0" class="bg-white border border-gray-200 rounded-lg p-12 text-center">
        ...
        <p class="text-gray-500 mb-4">还没有文章</p>
        <button
          @click="showCreateDialog = true"
      ...
      <div v-else class="space-y-3">
        <div
          v-for="blog in blogs"
          :key="blog._id"
          class="bg-white border border-gray-200 rounded-lg p-5 hover:border-gray-400 transition-colors"
        >
    ...
    >
      <div class="bg-white rounded-lg p-6 w-full max-w-lg">
        <h2 class="text-xl font-medium text-gray-800 mb-4">新建文章</h2>
    ...
    >
      <div class="bg-white rounded-lg p-6 w-full max-w-md">
        <h2 class="text-xl font-medium text-gray-800 mb-4">确认删除</h2>
...
const handleCreate = async () => {
  ...
  try {
    await trpc.createBlog.mutate({
      title: newBlog.value.title,
      content: '# ' + newBlog.value.title + '\n\n开始编写你的文章...',
      visibility: newBlog.value.visibility,
    })
