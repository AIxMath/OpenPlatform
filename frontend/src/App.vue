      ...
      <div class="max-w-7xl mx-auto px-4 h-14 flex items-center justify-between">
        <div class="flex items-center gap-6">
          <div class="flex items-center gap-2 cursor-pointer" @click="navigateTo('/')">
            <div class="text-blue-500 text-2xl font-bold font-serif">
              AI x Math
            </div>
          </div>
              ...
              <div class="relative" @click.stop>
                ...
                <Transition name="dropdown">
                  ...
                  >
                    ...
                    >
                      <div class="i-carbon-document-management text-gray-500 text-lg" />
                    ...
                    >
                      <div class="i-carbon-edit text-gray-500 text-lg" />
                    ...
                    >
                      <div class="i-carbon-settings text-gray-500 text-lg" />
